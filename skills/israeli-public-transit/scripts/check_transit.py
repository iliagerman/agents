...
def show_fares() -> None:
    ...
    print("Fare structure (updated April 2025; verify current fares before travel):")
    print("  - Single ride (urban, 0-15km): 8 NIS; a further ~12% hike was announced for June 2026 but may be deferred")
